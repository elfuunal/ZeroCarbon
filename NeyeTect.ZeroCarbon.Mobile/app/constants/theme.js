...
export const IMAGES = {
	...
	zeroCarbonLogo : require('../assets/images/global/zerocarbonlogo.png'),
	...
	w3tube : require('../assets/images/global/w3tube.png'),
	...
	loginShape : require('../../apps/education_app/assets/images/loginShape.png'), 
	...
	// post images global start
	post1 : require('../assets/images/global/post/pic1.png'),
	post2 : require('../assets/images/global/post/pic2.png'),
	post3 : require('../assets/images/global/post/pic3.png'),
	post4 : require('../assets/images/global/post/pic4.png'),
	post5 : require('../assets/images/global/post/pic5.png'),
	post6 : require('../assets/images/global/post/pic6.png'),
	post7 : require('../assets/images/global/post/pic7.png'),
	post8 : require('../assets/images/global/post/pic8.png'),
	post9 : require('../assets/images/global/post/pic9.png'),
	post10 : require('../assets/images/global/post/pic10.png'),
	post11 : require('../assets/images/global/post/pic11.png'),
	post12 : require('../assets/images/global/post/pic12.png'),
	post13 : require('../assets/images/global/post/pic13.jpg'),
	post14 : require('../assets/images/global/post/pic14.jpg'),
	post15 : require('../assets/images/global/post/pic15.jpg'),
	post16 : require('../assets/images/global/post/pic16.jpg'),
	post17 : require('../assets/images/global/post/pic17.jpg'),
	post18 : require('../assets/images/global/post/pic18.jpg'),
	post19 : require('../assets/images/global/post/pic19.jpg'),
	post20 : require('../assets/images/global/post/pomegranate.png'),
	post21 : require('../assets/images/global/post/strawberry.png'),
	// post images global end

	//education app images start
	eduPattern1 : require('../../apps/education_app/assets/images/pattern/pattern1.png'),
	eduPattern2 : require('../../apps/education_app/assets/images/pattern/pattern2.png'),
	eduPattern3 : require('../../apps/education_app/assets/images/pattern/pattern3.png'),
	eduBnr1 : require('../../apps/education_app/assets/images/pic1.png'),
	eduBnr2 : require('../../apps/education_app/assets/images/pic2.png'),
	eduCourse1 : require('../../apps/education_app/assets/images/course/pic1.png'),
	eduPic1 : require('../../apps/education_app/assets/images/course/small/pic1.png'),
	eduPic2 : require('../../apps/education_app/assets/images/course/small/pic2.png'),
	eduPic3 : require('../../apps/education_app/assets/images/course/small/pic3.png'),
	eduPic4 : require('../../apps/education_app/assets/images/course/small/pic4.png'),
	eduPic5 : require('../../apps/education_app/assets/images/course/small/pic5.png'),
	...
	//users
	user1 : require('../assets/images/global/stories/small/pic1.jpg'),
	user2 : require('../assets/images/global/stories/small/pic2.jpg'),
	user3 : require('../assets/images/global/stories/small/pic3.jpg'),
	user4 : require('../assets/images/global/stories/small/pic4.jpg'),
	user5 : require('../assets/images/global/stories/small/pic5.jpg'),
	user6 : require('../assets/images/global/stories/small/pic6.jpg'),
	user7 : require('../assets/images/global/stories/small/pic7.jpg'),
	user8 : require('../assets/images/global/stories/small/pic8.jpg'),


	//classified app images start
	cfItem1 : require('../../apps/classified_app/assets/images/item/pic1.png'), 
	cfItem2 : require('../../apps/classified_app/assets/images/item/pic2.png'), 
	cfItem3 : require('../../apps/classified_app/assets/images/item/pic3.png'), 
	cfItem4 : require('../../apps/classified_app/assets/images/item/pic4.png'), 
	cfItem5 : require('../../apps/classified_app/assets/images/item/pic5.png'), 
	cfItem6 : require('../../apps/classified_app/assets/images/item/pic6.png'), 
	cfItem7 : require('../../apps/classified_app/assets/images/item/pic7.png'), 
	cfItem8 : require('../../apps/classified_app/assets/images/item/pic8.png'), 
	cfItem9 : require('../../apps/classified_app/assets/images/item/pic9.png'), 
	cfItem10 : require('../../apps/classified_app/assets/images/item/pic10.png'), 
	cfDetail1 : require('../../apps/classified_app/assets/images/item/detail/pic1.png'), 
	cfDetail2 : require('../../apps/classified_app/assets/images/item/detail/pic2.png'), 
	cfDetail3 : require('../../apps/classified_app/assets/images/item/detail/pic3.png'), 
	cfDetail4 : require('../../apps/classified_app/assets/images/item/detail/pic4.png'), 
	cfDetail5 : require('../../apps/classified_app/assets/images/item/detail/pic5.png'), 
	car : require('../../apps/classified_app/assets/images/categories/car.png'), 
	building : require('../../apps/classified_app/assets/images/categories/building.png'), 
	iphone : require('../../apps/classified_app/assets/images/categories/iphone.png'), 
	suitcase : require('../../apps/classified_app/assets/images/categories/suitcase.png'), 
	motorbike : require('../../apps/classified_app/assets/images/categories/motorbike.png'), 
	desktop : require('../../apps/classified_app/assets/images/categories/desktop.png'), 
	furniture : require('../../apps/classified_app/assets/images/categories/furniture.png'), 
	dress : require('../../apps/classified_app/assets/images/categories/dress.png'), 
	cfPattern1 : require('../../apps/classified_app/assets/images/pattern/pattern1.png'), 
	//classified app images end
	
	// welcome demo images
	demo1 : require('../assets/images/global/demo/demo1.png'),
	demo2 : require('../assets/images/global/demo/demo2.png'),
	demo3 : require('../assets/images/global/demo/demo3.png'),
	demo4 : require('../assets/images/global/demo/demo4.png'),
	demo5 : require('../assets/images/global/demo/demo5.png'),
	demo6 : require('../assets/images/global/demo/demo6.png'),
	demo7 : require('../assets/images/global/demo/demo7.png'),
	demo8 : require('../assets/images/global/demo/demo8.png'),
	demo9 : require('../assets/images/global/demo/demo9.png'),
	demo10 : require('../assets/images/global/demo/demo10.png'),
	demoDark1 : require('../assets/images/global/demo/demoDark1.png'),
	demoDark2 : require('../assets/images/global/demo/demoDark2.png'),
	demoDark3 : require('../assets/images/global/demo/demoDark3.png'),
	demoDark4 : require('../assets/images/global/demo/demoDark4.png'),
	demoDark5 : require('../assets/images/global/demo/demoDark5.png'),
	demoDark6 : require('../assets/images/global/demo/demoDark6.png'),
	demoDark7 : require('../assets/images/global/demo/demoDark7.png'),
	demoDark8 : require('../assets/images/global/demo/demoDark8.png'),
	demoDark9 : require('../assets/images/global/demo/demoDark9.png'),
	demoDark10 : require('../assets/images/global/demo/demoDark10.png'),


	// stories images
	story1 : require('../assets/images/global/stories/pic1.png'),
	story2 : require('../assets/images/global/stories/pic2.png'),
	story3 : require('../assets/images/global/stories/pic3.png'),
	story4 : require('../assets/images/global/stories/pic4.png'),
	story5 : require('../assets/images/global/stories/pic5.png'),
	story6 : require('../assets/images/global/stories/pic6.png'),
	story7 : require('../assets/images/global/stories/pic7.png'),
	story8 : require('../assets/images/global/stories/pic8.png'),
