                        ...
                        <View style={{ backgroundColor: '#332A5E' }}>
                            <View style={GlobalStyleSheet.container}>
                                <View style={{ marginBottom: 30 }}>
                                    <Text style={[FONTS.h2, { textAlign: 'center', color: COLORS.white }]}>Şifre Değiştirme Talebi Başarılı</Text>
                                    <Text style={[FONTS.font, { textAlign: 'center', color: COLORS.white, opacity: .7 }]}>Eğer mail adresiniz sistemimizde kayıtlı ise şifre değiştirme ile ilgili talimatlarınız mail adresinize gönderilmiştir.</Text>
                                </View>
