            ...
            <View style={{ flex: 1, backgroundColor: colors.card }}>
                ...
                <View style={{ paddingHorizontal: 15, paddingVertical: 20, flex: 1 }}>
                    ...
                    >
                        ...
                        <Text style={[styles.navText, { color: colors.text }]}>Çıkış Yap</Text>
                        <FeatherIcon size={16} color={colors.text} name={'chevron-right'} />
                    </TouchableOpacity>
                    <Divider />

                    <Text style={{ ...FONTS.h6, color: colors.title, marginBottom: 5 }}>Ayarlar</Text>
                    <TouchableOpacity
                        style={[styles.navLink]}
                    >
                        <SvgXml style={{ marginRight: 10 }} xml={dark} />
                        <Text style={[styles.navText, { color: colors.text }]}>Karanlık Mod</Text>
                        <ToggleStyle1
                            active={theme.dark}
                            onToggle={(value) => {
                                if (value) {
                ...
                <View style={{ paddingBottom: 30, paddingHorizontal: 15, paddingTop: 20 }}>
                    <Text style={{ ...FONTS.font, color: colors.text }}>Zero Carbonizer 1.0</Text>
                </View>
            </View>
        </>
    );
